...
folderInfo = dir(fullfile(imgFolderPath,'*.jpg'));
testIms = cell(1,length(folderInfo));
for n = 1:length(folderInfo)
    testIms{n} = folderInfo(n).name;
end
for i=24001:27000
    fprintf('%d \n', i);
...
save('boxes09.mat','boxes','testIms');
